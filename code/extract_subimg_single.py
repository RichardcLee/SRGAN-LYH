...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_folder', type=str, default='./Train/Original', help='the path of input folder')
    parser.add_argument('--save_folder', type=str, default='./Train/Crop_Original', help='the path of save folder')
    opt = parser.parse_args()
    print(opt)
    main(opt.input_folder, opt.save_folder)